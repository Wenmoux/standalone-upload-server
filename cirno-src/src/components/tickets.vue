      ...
      <div class="container">
        <div class="tickets">
          <div class="ticket">
            ...
            <a-input-number v-model:value="recommandNum" :min="0" :max="parseInt(prop_info.rest_recommend)" size="small" />
          </div>
          <!-- <div class="ticket">
            <div class="title">投月票</div>
            <a-input-number v-model:value="ypNum" :min="0" :max="prop_info.rest_yp" size="small" />
          </div>
          <div class="ticket">
            <div class="title">投刀片</div>
            <a-input-number v-model:value="bladeNum" :min="0" :max="prop_info.rest_month_blade" size="small" />
          </div> -->
        </div>
        <div class="info">
