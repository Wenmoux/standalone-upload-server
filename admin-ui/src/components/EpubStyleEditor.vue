...
.asset-title-row .custom {
    color: #0f5f58;
    background: #d9f4ef;
}
.asset-title-row .builtin {
    color: #526579;
    background: #e7edf3;
}
.asset-copy small {
