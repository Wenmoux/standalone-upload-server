/**
 * [INPUT]: 依赖 command-registry 的注册接口与调用方注入的账户、签到、管理员广播、流水和后台任务处理器
 * [OUTPUT]: 对外提供账户与管理员通知域 Telegram 命令的集中注册函数
...
function registerAccountCommands(registry, handlers = {}) {
    ...
    registry.register({ command: "/broadcast", description: "管理员发布全员通知", action: "broadcast", handler: ({ message, args }) => handleBroadcast(message, args) });
