...
const BOT_COMMAND_CATALOG = [
    ...
    { command: "/search", group: "搜书", description: "搜索书籍", help: "/search 关键词或#标签 [-平台]", telegramMenu: true },
    { command: "/hot", group: "搜书", description: "热门书籍", help: "/hot [-平台]", telegramMenu: true },
    { command: "/wordcloud", group: "搜书", description: "热搜词云", help: "/wordcloud [-平台]", aliases: ["/cloud"] },
    { command: "/random", group: "搜书", description: "随机推荐", help: "/random [-平台]", telegramMenu: true },
