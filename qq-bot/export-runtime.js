 ...
 * [OUTPUT]: 对外提供 QQ 用户自动注册和复用 Telegram 同款 EPUB 样式/计费规则的导出函数
...
const { EPUB_EXPORT_STYLE_CHOICES, normalizeEpubStyleChoice } = require("../bot/epub-style-picker");
...
function createQqExportRuntime(options = {}) {
    ...
    async function exportBook(event, bookId, format, epubStyleId = "") {
        const profile = {
            id: event.identity,
